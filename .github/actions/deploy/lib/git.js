...
function init(action) {
  return __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      throw new Error(
        `There was an error initializing the repository: ${util_1.suppressSensitiveInformation(
          error.message,
          action
        )} ❌`
      )
...
function switchToBaseBranch(action) {
  return __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      throw new Error(
        `There was an error switching to the base branch: ${util_1.suppressSensitiveInformation(
          error.message,
          action
        )} ❌`
      )
...
function generateBranch(action) {
  return __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      throw new Error(
        `There was an error creating the deployment branch: ${util_1.suppressSensitiveInformation(
          error.message,
          action
        )} ❌`
      )
  ...
  return __awaiter(this, void 0, void 0, function*() {
    ...
    try {
      ...
      /*
              ...
              */
      const branchExists = yield execute_1.execute(
      ...
      yield execute_1.execute(
        `rsync -q -av --checksum --progress ${action.folderPath}/. ${
          ...
          action.clean
            ? `--delete ${excludes} ${
                !fs_1.default.existsSync(`${action.folderPath}/CNAME`)
                  ? '--exclude CNAME'
                  : ''
              } ${
      ...
      const hasFilesToCommit = yield execute_1.execute(
      ...
      throw new Error(
        `The deploy step encountered an error: ${util_1.suppressSensitiveInformation(
          error.message,
          action
        )} ❌`
      )
